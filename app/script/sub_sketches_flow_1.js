...
function init(){
  ...
  for (var  i = 0; i < tot; i++){
    ...
    var col = color(255 * s,5); //Randomly choose between black and (182, 103, 13), with alpha equal to 2;

    elements.push( new Element(width/2,height/2, random(40, 60), col));
...
function Element(x, y, rad, col){
  ...
  this.bounce = function(){
    ...
    if(dist(this.pos.x, this.pos.y, width/2, height/2) > width/2*0.4){
